...
export default function AboutFounder({ theme }) {
  ...
  return (
    <section id="about" className={`py-24 relative overflow-hidden border-t border-b transition-colors duration-300 ${
      isDark ? 'bg-[#0c121e] border-slate-800/80' : 'bg-[#ebf7ff] border-blue-200/60'
    }`}>
      
      {/* Ambient background glow */}
      <div className={`absolute top-1/2 left-0 w-96 h-96 blur-[120px] rounded-full pointer-events-none ${
        isDark ? 'bg-blue-600/10' : 'bg-[#015CCF]/10'
      }`} />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
          ...
          <h2 className={`text-3xl sm:text-4xl font-extrabold tracking-tight font-sans ${
            ...
            The Mastermind Behind <span className={isDark ? 'text-gradient-cyan' : 'text-gradient-primary'}>YM Automation</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch mb-16">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className={`text-xs font-mono font-bold ${isDark ? 'text-cyan-400' : 'text-[#015CCF]'}`}>Managing Director, YM Automation Pvt Ltd</p>
                </div>
              </div>
          ...
          <div className={`lg:col-span-5 rounded-3xl p-8 border flex flex-col justify-between space-y-6 ${
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <div className={`p-3 rounded-2xl border ${
                  isDark ? 'bg-blue-500/10 text-blue-400 border-blue-500/20' : 'bg-blue-100 text-[#015CCF] border-blue-200'
                }`}>
                  <Award className="w-6 h-6" />
                </div>
                <div>
                  <h3 className={`text-xl font-bold ${isDark ? 'text-white' : 'text-slate-900'}`}>Certifications & Honors</h3>
                  <p className={`text-xs font-mono font-bold ${isDark ? 'text-blue-400' : 'text-[#015CCF]'}`}>Industrial Endorsement</p>
                </div>
              </div>
              ...
              <div className={`p-5 rounded-2xl border space-y-3 ${
                ...
                <div className="flex items-center justify-between">
                  <span className={`text-xs font-mono font-bold ${isDark ? 'text-cyan-400' : 'text-[#015CCF]'}`}>LARSEN & TOUBRO</span>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className={`p-4 rounded-xl border text-center ${
                  ...
                  <div className={`text-2xl font-extrabold font-mono ${isDark ? 'text-cyan-400' : 'text-[#015CCF]'}`}>B.E. + M.S.</div>
            ...
            <div className={`p-4 rounded-xl border flex items-center justify-between text-xs font-mono ${
              ...
              <span className={`font-bold ${isDark ? 'text-slate-200' : 'text-[#015CCF]'}`}>Coimbatore, Tamil Nadu</span>
            </div>
              ...
              return (
                ...
                >
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <span className={`px-2 py-0.5 rounded text-[10px] font-mono font-bold border ${
                        isDark ? 'bg-slate-800 text-cyan-300 border-slate-700' : 'bg-blue-50 text-[#015CCF] border-blue-200'
                      }`}>
                        {item.tag}
                      </span>
                    </div>
                    ...
                    <p className={`text-xs font-mono font-bold ${isDark ? 'text-cyan-400' : 'text-[#015CCF]'}`}>
                      {item.institution}
                    </p>
                  ...
                  <div className={`pt-3 border-t text-[11px] font-mono flex items-center gap-1.5 ${
                    isDark ? 'border-slate-800/60 text-slate-300' : 'border-slate-100 text-slate-700 font-medium'
                  }`}>
